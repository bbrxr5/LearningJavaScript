...
$(window).load(function(){
	...
	#("#bigger").click(function(e){move(e, "bigger");});
	#("#smaller").click(function(e){move(e, "smaller");});
	#("#tile").click(function(e){move(e, "tile");});
	#("#stack").click(function(e){move(e, "stack");});
	#("#flip").click(function(e){move(e, "flip");});
	stack();
});
